...
size_t AltThreeKernel::num_points_training = NUM_TRAINING;
size_t AltThreeKernel::num_points_testing = NUM_TESTING;
size_t AltThreeKernel::num_features = NUM_FEATURES;

AltThreeKernel::AltThreeKernel(
    const char *filename,
...
int AltThreeKernel::setup_kernel() {
...
bool AltThreeKernel::check_results() {
